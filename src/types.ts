...
export interface ChannelAdapter {
  ...
  /**
   * Post an image into the Pantheon arts hall (declarative AI art / memes).
   * Optional — falls back to announceImage() / announce().
   */
  announcePantheonArt?(image: Buffer, caption: string): Promise<void>;
  /**
   * Post a tale / banter line into the Pantheon tales hall.
   * Optional — falls back to announce().
   */
  announcePantheonTale?(text: string): Promise<void>;

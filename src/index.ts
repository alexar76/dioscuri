...
async function main(): Promise<void> {
  ...
  if (cfg.discord.enabled) {
    let { announceChannelId, modLogChannelId, gallerySpotlightChannelId, pantheonArtsChannelId,
      pantheonTalesChannelId, canonChannelId, generalChannelId,
    ...
    if (cfg.discord.autoStructure) {
      ...
      pantheonArtsChannelId = pantheonArtsChannelId || res.pantheonArtsChannelId;
      pantheonTalesChannelId = pantheonTalesChannelId || res.pantheonTalesChannelId;

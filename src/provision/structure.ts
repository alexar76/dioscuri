...
/**
 * Pantheon of declarative art — twins light new AI arts and tales here.
 * Distinct from THE GALLERY (builders' projects): this hall is creative output.
 */
export const PANTHEON_CATEGORY = "🎨 THE PANTHEON";
export const PANTHEON_ARTS_CHANNEL = "pantheon-arts";
export const PANTHEON_TALES_CHANNEL = "pantheon-tales";
...
export const DESIRED_STRUCTURE: DesiredStructure = {
  ...
  categories: [
    ...
    {
      name: PANTHEON_CATEGORY,
      channels: [
        {
          name: PANTHEON_ARTS_CHANNEL,
          type: "text",
          overwrites: "readonly",
          topic:
            "Pantheon of declarative art — AI visuals the twins mint (memes, cards, demo stills). Read-only; talk in #general.",
        },
        {
          name: PANTHEON_TALES_CHANNEL,
          type: "text",
          overwrites: "readonly",
          topic:
            "Stories and banter the twins tell across heavens — setups, punchlines, short tales. Read-only; talk in #general.",
        },
      ],
    },
    {

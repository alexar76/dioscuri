...
**Ecosystem guide:** [theoros-integration.md](https://github.com/alexar76/aicom/blob/main/docs/ecosystem/theoros-integration.md) (monorepo)
...
Full essay: **[theoros/docs/WHY.md](https://github.com/alexar76/theoros/blob/main/docs/WHY.md)**.
...
- [ ] `theoros/` mirrored to GitHub/Gitea ([satellite map](https://github.com/alexar76/aicom/blob/main/scripts/satellite-map.yaml))
...
| [theoros/docs/DISCORD.md](https://github.com/alexar76/theoros/blob/main/docs/DISCORD.md) | Channel map in corpus repo |
| [theoros/CANON.md](https://github.com/alexar76/theoros/blob/main/CANON.md) | Seven precepts (source of truth) |

...
<!-- aicom-readme-badges -->
<p align="center">
  <a href="https://github.com/alexar76/dioscuri/actions/workflows/ci.yml"><img src="https://raw.githubusercontent.com/alexar76/dioscuri/refs/heads/main/docs/badges/ci.svg" alt="CI" /></a>
  <a href="https://www.npmjs.com/package/@alexar76/dioscuri"><img src="https://raw.githubusercontent.com/alexar76/dioscuri/refs/heads/main/docs/badges/npm.svg" alt="npm" /></a>
  <a href="https://github.com/alexar76/dioscuri/releases"><img src="https://raw.githubusercontent.com/alexar76/dioscuri/refs/heads/main/docs/badges/release.svg" alt="Release" /></a>
  <a href="https://alexar76.github.io/dioscuri/"><img src="https://raw.githubusercontent.com/alexar76/dioscuri/refs/heads/main/docs/badges/pages.svg" alt="Landing" /></a>
  <img src="https://raw.githubusercontent.com/alexar76/dioscuri/refs/heads/main/docs/badges/node.svg" alt="node >=20" />
  <img src="https://raw.githubusercontent.com/alexar76/dioscuri/refs/heads/main/docs/badges/typescript.svg" alt="TypeScript strict" />
  <a href="https://raw.githubusercontent.com/alexar76/dioscuri/refs/heads/main/docs/badges/coverage.svg"><img src="https://raw.githubusercontent.com/alexar76/dioscuri/refs/heads/main/docs/badges/coverage.svg" alt="Test coverage" /></a>
  <a href="https://github.com/alexar76/dioscuri/blob/main/LICENSE"><img src="https://raw.githubusercontent.com/alexar76/dioscuri/refs/heads/main/docs/badges/license.svg" alt="License: MIT" /></a>
</p>
<!-- /aicom-readme-badges -->
...
| Signal Hunt hero relay | Pulls the game's opt-in milestone feed, verifies exact Ed25519-signed bytes against an operator-pinned key, and delivers each new hero once per armed Discord/X sink; no social credential ever enters the game |
...
| `SIGNAL_HUNT_HERO_FEED_URL` | Optional signed Signal Hunt hero feed; requires the pinned key below | — |
| `SIGNAL_HUNT_HERO_PUBKEY_B64` | Ed25519 provider key verified out of band; the feed cannot choose its own trust root | — |
| `SIGNAL_HUNT_HERO_POLL_MINUTES` | Pull interval for future opt-in milestones | `5` |
| `SIGNAL_HUNT_HERO_MAX_POSTS` | Delivery ceiling per polling cycle | `3` |
...
flowchart TD
    ...
    SH["Signal Hunt — signed opt-in hero feed"] -->|"pull + pinned Ed25519 key"| HR["HERO RELAY — persistent per-sink delivery"]
    HR --> PX
    HR --> KX["KERYX — X post-only sink"]
...
| [../signal-hunt/docs/DIOSCURI_RELAY.md](https://github.com/alexar76/signal-hunt/blob/main/docs/DIOSCURI_RELAY.md) | Signal Hunt hero relay — trust boundary, key pinning, delivery semantics and health fields |
...
**Ecosystem:** [Landing](https://alexar76.github.io/dioscuri/) · [magic-ai-factory.com](https://magic-ai-factory.com) · [Alien Monitor](https://monitor.modelmarket.dev/) (DIOSCURI graph node) · [github.com/alexar76/dioscuri](https://github.com/alexar76/dioscuri) · [integration guide](https://github.com/alexar76/aicom/blob/main/docs/ecosystem/dioscuri-integration.md)

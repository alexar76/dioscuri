#!/usr/bin/env python3
"""Write docs/badges/coverage.svg from vitest json-summary coverage."""
...
DEFAULT_IN = ROOT / "coverage" / "coverage-summary.json"
...
def main(argv: list[str] | None = None) -> int:
    ...
    if not in_path.is_file():
        print(f"coverage summary not found: {in_path}", file=sys.stderr)
        print("Run: npm run test:coverage", file=sys.stderr)
        return 1
